...
public class Packet implements PacketFactory{
	...
	public final static int ETC = 2;//menu, adlist 데이터 요청(코드 : 1100, 1101, 1104)
	public final static int PROGRAM_LIST = 3;//program_list 데이터 요청(코드 : 1102)
	public final static int PROGRAM_DETAIL = 4;//program_detail 데이터 요청(코드 : 1103)
	public final static int PAY = 5;//결제 요청(코드 : 1200)
	public final static int FTP = 6;//ftp 요청(코드  : 1300)
	
	//H3과 같이 동일한 패킷 구조에 데이터만 다를 경우 옵션 형태로 처리하기 위해 정의
	public final static int OPTION_NONE = -1;//옵션이 없을 경우
	public final static int OPTION_MENU_VERSION = 0;//코드 : 1100
	public final static int OPTION_MENU = 1;//코드 : 1101
	public final static int OPTION_AD = 2;//코드 : 1104
	...
	public PacketAgent choosePacketAgent(int type, int option)
		...
		case ETC :
			return agent = new ETCAgent(option);
		case PROGRAM_LIST :
			return agent = new ProgramListAgent(option);
		case PROGRAM_DETAIL :
			return agent = new ProgramDetailAgent(option);
		case PAY :
